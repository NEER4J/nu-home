...
export default function EnquiryLayout({
  ...
  const canProceedToStep2 = Object.keys(uploadedImages).length > 0
            ...
            <div className="mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  A member of our team will be in touch super-soon to discuss your enquiry. If you have any questions, contact our team on {partnerPhone || '0330 113 1333'}.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid gap-4">
                ...
                <div className="flex justify-between">
                  ...
                  <span className={`font-medium ${classes.textColored}`}>{customerDetails.email}</span>
                </div>
              </div>
              
              <div className="mt-6 pt-6 border-t">
                <h4 className="font-semibold text-gray-900 mb-4">Install details</h4>
                <div className="flex justify-between">
                  <span className="text-gray-600">Postcode</span>
                  <span className="font-medium">{customerDetails.postcode}</span>
                </div>
              </div>
            </div>
          </>
