          ...
          <div className="flex items-center gap-4">
            ...
            {selectedCategory && (
              <button 
                ...
                className="flex items-center gap-1 px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 mt-5"
              >
