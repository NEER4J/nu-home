...
export default function EVChargerProductsPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Our EV Charger Solutions</h1>
            ...
            {filteredProducts.map((product) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    href={`/category/ev-chargers/products/${product.slug}`}
