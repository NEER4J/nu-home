...
export async function POST(request: NextRequest) {
  console.log('🚀🚀🚀 enquiry-submitted-v2 API called 🚀🚀🚀')
  ...
  try {
    ...
    console.log('enquiry-submitted-v2 - Parsed hostname:', hostname);
    ...
    // Note: GHL lead is created from frontend (in app/boiler/enquiry/page.tsx), not backend
