  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // 2. Fetch products for this partner and the ASHP category
...
function AshpProductCard({ product, brandColor, onSelect, isHorizontal }: {
...
export default function AshpProductsPageWrapper() {
  return (
    <Suspense fallback={<AshpProductsLoading />}>
      <AshpProductsPage />
    </Suspense>
  )
}