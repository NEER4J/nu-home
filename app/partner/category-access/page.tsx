        ...
        {availableCategories.length === 0 ? (
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 text-center">
            ...
            <p className="text-sm text-gray-500">
              You've already requested access to all available service categories.
            </p>
          </div>
        ) : (
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
            <p className="text-sm text-gray-600 mb-6">
              Select a category below to request access. Once approved by an admin, you'll be able to add products and receive leads.
            </p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Explain why you want access to this category and your experience/qualifications..."
                    required
                  ></textarea>
                </div>
