// Default templates for checkout-stripe email type

export function getDefaultCustomerCheckoutStripeTemplate() {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
export function getDefaultCustomerCheckoutStripeTextTemplate() {
  return `Payment Confirmed - Your Boiler Installation with {{companyName}}
...
export function getDefaultAdminCheckoutStripeTemplate() {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px 0; font-size: 16px; color: #374151; line-height: 1.6;">
                A customer has completed payment and booked an installation with <strong>{{companyName}}</strong>. 
...
export function getDefaultAdminCheckoutStripeTextTemplate() {
  return `Payment Confirmed - Installation Booking - {{companyName}}
