// Default templates for checkout-pay-later email type

export function getDefaultCustomerCheckoutPayLaterTemplate() {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              <div style="text-align: center; margin-bottom: 30px;">
                ...
                <p style="color: #6b7280; font-size: 16px; margin: 8px 0 0 0;">Pay after your installation is complete with {{companyName}}</p>
              </div>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 30px; border-collapse: collapse; border: 1px solid #e5e7eb; border-radius: 8px; overflow: hidden;">
                <tr>
                  <td style="background-color: #fef3c7; padding: 15px; font-weight: 600; color: #374151; border-bottom: 1px solid #e5e7eb;">
                    Payment Information
                  </td>
                </tr>
                <tr>
...
export function getDefaultCustomerCheckoutPayLaterTextTemplate() {
  return `Installation Booked - Pay After Completion with {{companyName}}
...
export function getDefaultAdminCheckoutPayLaterTemplate() {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px 0; font-size: 16px; color: #374151; line-height: 1.6;">
                A customer has booked an installation with pay-after-completion option with <strong>{{companyName}}</strong>. 
...
export function getDefaultAdminCheckoutPayLaterTextTemplate() {
  return `New Pay After Installation Booking - {{companyName}}
