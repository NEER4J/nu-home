// Default templates for solar esurvey-submitted email type

export function getDefaultSolarCustomerESurveySubmittedTemplate() {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px 0; font-size: 16px; color: #374151; line-height: 1.6; text-align: center;">
                We've received your photos and our team will review them carefully. This will help us provide you with a more accurate quote for your solar installation.
              </p>
...
export function getDefaultSolarCustomerESurveySubmittedTextTemplate() {
...
export function getDefaultSolarAdminESurveySubmittedTemplate() {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
export function getDefaultSolarAdminESurveySubmittedTextTemplate() {
