// Default templates for solar callback-requested email type

export function getDefaultSolarCustomerCallbackRequestedTemplate() {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="margin: 0 0 30px 0; font-size: 16px; color: #374151; line-height: 1.6; text-align: center;">
                We've received your callback request and our team will contact you within 24 hours to discuss your solar installation requirements.
              </p>
              ...
              <div style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                ...
                <ul style="margin: 0; padding-left: 20px; color: #374151; font-size: 14px; line-height: 1.6;">
                  ...
                  <li>We'll discuss your solar installation requirements</li>
...
export function getDefaultSolarCustomerCallbackRequestedTextTemplate() {
...
- We'll discuss your solar installation requirements
...
export function getDefaultSolarAdminCallbackRequestedTemplate() {
    return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
      ...
      <td align="center" style="padding: 20px 0;">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: white; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <td style="padding: 40px 30px;">
              ...
              <div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 8px; padding: 20px; margin-bottom: 30px;">
                ...
                <p style="margin: 0; color: #dc2626; font-weight: 600;">
                  Please call this customer within 24 hours to discuss their solar installation requirements.
                </p>
              </div>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 20px 30px; border-radius: 0 0 8px 8px; text-align: center;">
              <p style="margin: 0; font-size: 14px; color: #6b7280;">
                This callback request was submitted through your solar quote system.<br>
...
export function getDefaultSolarAdminCallbackRequestedTextTemplate() {
    return `New Callback Request

A customer has requested a callback to discuss their solar installation.
...
ACTION REQUIRED: Please call this customer within 24 hours to discuss their solar installation requirements.

Contact Information:
- Phone: {{phone}}
- Email: {{email}}

This callback request was submitted through your solar quote system.
Submission ID: {{submission.id}} | {{submission.created_at}}`
}
